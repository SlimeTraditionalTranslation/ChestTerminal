...
public class ChestTerminal extends JavaPlugin implements Listener, SlimefunAddon {
	...
	public void onEnable() {
		...
		SlimefunItemStack wirelessTerminal128 = new SlimefunItemStack("CT_WIRELESS_ACCESS_TERMINAL_128", Material.ITEM_FRAME, "&3CT 無限存取終端 &b(128)", "&8\u21E8 &7連結至: &c無處", "&8\u21E8 &7範圍: &e128 Blocks", "&c&o&8\u21E8 &e\u26A1 &70 / 50 J", "", "&7如果此模塊鏈接到接入終端", "&7它將能夠遠程訪問該終端", "", "&7&e右鍵點擊訪問終端 &7鏈接", "&7&e右鍵&7來打開連結的終端");
