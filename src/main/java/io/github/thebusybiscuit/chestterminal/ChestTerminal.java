...
public class ChestTerminal extends JavaPlugin implements Listener, SlimefunAddon {
	...
	public void onEnable() {
		...
		ItemGroup itemGroup = new ItemGroup(new NamespacedKey(this, "chest_terminal"), new CustomItemStack(chestTerminal, "&5箱子終端", "", "&a> 點擊開啟"));
	...
	public String getBugTrackerURL() {
		return "https://github.com/SlimeTraditionalTranslation/ChestTerminal/issues";
	}
}
