...
public class AccessTerminal extends SimpleSlimefunItem<BlockTicker> {
    ...
    public AccessTerminal(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        new BlockMenuPreset(getId(), "&3終端介面") {
            ...
            public void newInstance(BlockMenu menu, Block b) {
                menu.replaceExistingItem(46, new CustomItemStack(SlimefunUtils.getCustomHead("f2599bd986659b8ce2c4988525c94e19ddd39fad08a38284a197f1b70675acc"), "&7\u21E6 上一頁", "", "&c(這可能需要幾秒鐘來更新)"));
                ...
                menu.replaceExistingItem(50, new CustomItemStack(SlimefunUtils.getCustomHead("c2f910c47da042e4aa28af6cc81cf48ac6caf37dab35f88db993accb9dfe516"), "&7下一頁 \u21E8", "", "&c(這可能需要幾秒鐘來更新)"));
    ...
    public BlockTicker getItemHandler() {
        return new BlockTicker() {
            ...
            private final ItemStack item = new CustomItemStack(Material.BARRIER, "&4沒有連接至任何物流網路!");
